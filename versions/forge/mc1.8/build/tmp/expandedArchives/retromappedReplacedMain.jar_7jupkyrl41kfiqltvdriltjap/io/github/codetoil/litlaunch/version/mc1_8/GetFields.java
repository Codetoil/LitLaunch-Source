...
public class GetFields implements IGetFields
{
		...
		try {
			...
			if (world == null) // World for dimension is not loaded, but check entityworld
			{
				...
				if (world != null) {
					...
					if (provider != null) {
						if (world.field_73011_w.func_177502_q() == dimension) {
							result = world.func_82737_E();
						} else {
							result = -1;
	...
	{
		return net.minecraft.client.Minecraft.func_71410_x().field_71439_g.field_71093_bK;
	}
